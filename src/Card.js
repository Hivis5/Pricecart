        ...
        <div class="card mb-5 mb-lg-0">
          <div class="card-body">
            ...
            <ul class="fa-ul">
              ...
              <li class={props.type.communityaccessEnabler?"":"text-muted"}><span class="fa-li"><i class={props.type.communityaccessEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.type.communityaccess}</li>
              ...
              <li class={props.type.subdomainEnabler?"":"text-muted"}><span class="fa-li"><i class={props.type.subdomainEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.type.title==="PRO"?<><b>{props.type.prefixsubdomain}</b> {props.type.subdomain}</>:<>{props.type.subdomain}</>}</li>
              <li class={props.type.statusReportEnabler?"":"text-muted"}><span class="fa-li"><i class={props.type.statusReportEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.type.statusReport}</li>
            </ul>
            <div class="d-grid">
